...
import Event, { IEvent } from '@/database/event.model'; // Adjust path as needed
...
export async function GET(
    ...
    try {
        ...
        // Use === for comparison and check if slug exists
        ...
        // Corrected 'ProcessingInstruction' to 'process'
